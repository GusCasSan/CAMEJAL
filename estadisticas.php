...
<html>
  ...
  <body>
    <div class="container">
      <form action="estadisticaExel.php" method="POST">
        <div class="form-input">
          <label>Fecha Inicio</label><br>
		      <input type="date" name="fechainicio" step="1" value="<?php echo date("Y-m-d");?>" class="form-control">
        </div>
        <div class="form-input">
          <label>Fecha Final</label><br>
		      <input type="date" name="fechafinal" step="1" value="<?php echo date("Y-m-d");?>" class="form-control">
        </div>
        <br>
        <div  align="center">
